...
public class WDLMessages {
     ...
     *
     * @param type           The type of the message.
     * @param translationKey I18n key that is translated.
     * @param args           The arguments to pass to the {@link TextComponentTranslation}.
    ...
    public static void chatMessage(@Nonnull IWDLMessageType type, @Nonnull ITextComponent message) {
        ...
        String tooltipText = I18n.format("net.daporkchop.pepsimod.wdl.messages.tooltip",
    ...
    private static ITextComponent convertEntityToComponent(@Nonnull Entity e) {
        ...
        try {
            ...
            if (identifier == null) {
                wdlName = new TextComponentTranslation("net.daporkchop.pepsimod.wdl.messages.entityData.noKnownName");
            } else {
                ...
                hoverText.appendSibling(new TextComponentTranslation("net.daporkchop.pepsimod.wdl.messages.entityData.internalName", identifier));
                hoverText.appendText("\n");
                hoverText.appendSibling(new TextComponentTranslation("net.daporkchop.pepsimod.wdl.messages.entityData.group", displayGroup, group));
        ...
        return new TextComponentTranslation("net.daporkchop.pepsimod.wdl.messages.entityData", wdlName, displayName);
    }
