...
import net.daporkchop.pepsimod.wdl.api.ITileEntityEditor;
import net.daporkchop.pepsimod.wdl.api.ITileEntityEditor.TileEntityCreationMode;
import net.daporkchop.pepsimod.wdl.api.ITileEntityImportationIdentifier;
...
public class WDLChunkLoader extends AnvilChunkLoader {
    ...
    public static boolean shouldSaveEntity(Entity e) {
        ...
        if (!EntityUtils.isEntityEnabled(e)) {
            WDLMessages.chatMessageTranslated(
                    ...
                    "net.daporkchop.pepsimod.wdl.messages.removeEntity.notSavingUserPreference",
                    e);
            return false;
        }
            ...
            try {
                if (info.mod.shouldEdit(pos, compound, creationMode)) {
                    ...
                    WDLMessages.chatMessageTranslated(
                            ...
                            "net.daporkchop.pepsimod.wdl.messages.tileEntity.edited",
     ...
     * @param world The world the chunk is in, used to determine the modified
     *              time.
        ...
        for (Entity entity : entities) {
            ...
            try {
                ...
                WDLMessages.chatMessageTranslated(
                        ...
                        "net.daporkchop.pepsimod.wdl.messages.generalError.failedToSaveEntity",
        ...
        for (BlockPos pos : allTELocations) {
            ...
            if (newTEMap.containsKey(pos)) {
                ...
                try {
                    ...
                    WDLMessages.chatMessageTranslated(
                            WDLMessageTypes.ERROR,
                            "net.daporkchop.pepsimod.wdl.messages.generalError.failedToSaveTE",
                ...
                WDLMessages.chatMessageTranslated(
                        WDLMessageTypes.LOAD_TILE_ENTITY,
                        "net.daporkchop.pepsimod.wdl.messages.tileEntity.usingNew",
                        entityType, pos);
                ...
                WDLMessages.chatMessageTranslated(
                        WDLMessageTypes.LOAD_TILE_ENTITY,
                        "net.daporkchop.pepsimod.wdl.messages.tileEntity.usingOld",
                        entityType, pos);
    ...
    public Map<BlockPos, NBTTagCompound> getOldTileEntities(Chunk chunk) {
        ...
        try {
            ...
            if (oldList != null) {
                for (int i = 0; i < oldList.tagCount(); i++) {
                    ...
                    if (shouldImportTileEntity(entityID, pos, block, oldNBT, chunk)) {
                        ...
                        WDLMessages.chatMessageTranslated(
                                WDLMessageTypes.LOAD_TILE_ENTITY,
                                "net.daporkchop.pepsimod.wdl.messages.tileEntity.notImporting",
                                entityID, pos);
                    }
                }
            }
            ...
            WDLMessages.chatMessageTranslated(WDLMessageTypes.ERROR,
                    "net.daporkchop.pepsimod.wdl.messages.generalError.failedToImportTE",
                    chunk.x, chunk.z, e);
        }
        return returned;
    }
