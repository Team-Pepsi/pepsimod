...
public class WDLApi {
    ...
    private static final String IMPL = "net.daporkchop.pepsimod.wdl.api.APIImpl";
    /**
    ...
    interface APIInstance {
         ...
         */
        void saveTileEntity(BlockPos pos, TileEntity te);

        /**
         * @see {@link WDLApi#addWDLMod(String, String, IWDLMod)}
         */
        void addWDLMod(String id, String version, IWDLMod mod);

        /**
         * @see {@link WDLApi#getImplementingExtensions(Class)}
         */
        <T extends IWDLMod> List<ModInfo<T>> getImplementingExtensions(Class<T> clazz);

        /**
         * @see {@link WDLApi#getAllImplementingExtensions(Class)}
         */
        <T extends IWDLMod> List<ModInfo<T>> getAllImplementingExtensions(Class<T> clazz);
         ...
         */
        void setEnabled(String modID, boolean enabled);
    }
