...
public interface IWorldInfoEditor extends IWDLMod {
     ...
     *
     * @param world       The world that is being saved ({@link wdl.WDL#worldClient})
     * @param info        The given world's {@link WorldInfo}.
     ...
     *                    or add info to this.
     */
    void editWorldInfo(WorldClient world, WorldInfo info,
