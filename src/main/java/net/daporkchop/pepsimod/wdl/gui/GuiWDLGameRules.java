...
public class GuiWDLGameRules extends GuiScreen {
     ...
     *
     * @param ruleName The name of the rule.
     * @param value    The new value. Must not be null; to clear a rule, use
    ...
    @Override
    public void initGui() {
        this.title = I18n.format("net.daporkchop.pepsimod.wdl.gui.gamerules.title");
    ...
    private interface KeyboardEntry extends IGuiListEntry {
    ...
    private class GuiGameRuleList extends GuiListExtended {
        ...
        private class CreateCustomRuleEntry extends GuiListEntry implements KeyboardEntry {
            ...
            public CreateCustomRuleEntry() {
                this.title = I18n.format("net.daporkchop.pepsimod.wdl.gui.gamerules.custom");
                this.nameField = new GuiTextField(0, fontRenderer, 0, 0, 100, 20);
                this.createButton = new GuiButton(0, 0, 0, 100, 20, I18n.format("net.daporkchop.pepsimod.wdl.gui.gamerules.addCustom.name"));
            }
        ...
        private abstract class RuleEntry extends GuiListEntry {
            ...
            public final void drawEntry(int slotIndex, int x, int y, int listWidth,
                ...
                if (this.isMouseOverControl(mouseX, mouseY)) {
                    String key = "net.daporkchop.pepsimod.wdl.gui.gamerules.rules." + ruleName;
            ...
            protected String getResetText() {
                return I18n.format("net.daporkchop.pepsimod.wdl.gui.gamerules.resetRule");
            }
        }
        ...
        private class CustomRuleEntry extends RuleEntry implements KeyboardEntry {
            ...
            @Override
            protected String getResetText() {
                return I18n.format("net.daporkchop.pepsimod.wdl.gui.gamerules.deleteRule");
            }
