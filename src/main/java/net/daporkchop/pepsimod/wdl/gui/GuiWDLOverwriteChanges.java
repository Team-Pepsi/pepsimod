...
import net.daporkchop.pepsimod.wdl.WorldBackup;
import net.daporkchop.pepsimod.wdl.WorldBackup.IBackupProgressMonitor;
...
public class GuiWDLOverwriteChanges extends GuiTurningCameraBase implements
    ...
    public void initGui() {
        ...
        title = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.title");
        if (lastSaved != -1) {
            footer = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.footer", lastSaved, lastPlayed);
        } else {
            footer = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.footerNeverSaved", lastPlayed);
        }
        captionTitle = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.captionTitle");
        captionSubtitle = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.captionSubtitle");
        overwriteWarning1 = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.overwriteWarning1");
        overwriteWarning2 = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.overwriteWarning2");

        backingUpTitle = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.backingUp.title");
        ...
        backupAsZipButton = new GuiButton(0, x, y,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.asZip.name"));
        this.buttonList.add(backupAsZipButton);
        y += 22;
        backupAsFolderButton = new GuiButton(1, x, y,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.asFolder.name"));
        this.buttonList.add(backupAsFolderButton);
        y += 22;
        downloadNowButton = new GuiButton(2, x, y,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.startNow.name"));
        this.buttonList.add(downloadNowButton);
        y += 22;
        cancelButton = new GuiButton(3, x, y,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.cancel.name"));
        ...
        if (this.backingUp) {
            ...
            if (backupFile != null) {
                String text = I18n.format(
                        "net.daporkchop.pepsimod.wdl.gui.overwriteChanges.backingUp.progress",
            ...
            if (backupAsZipButton.isMouseOver()) {
                tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.asZip.description");
            } else if (backupAsFolderButton.isMouseOver()) {
                tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.asFolder.description");
            } else if (downloadNowButton.isMouseOver()) {
                tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.startNow.description");
            } else if (cancelButton.isMouseOver()) {
                tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.cancel.description");
            }
    ...
    private class BackupThread extends Thread {
        ...
        public void run() {
            try {
                ...
                if (zip) {
                    backupData = I18n
                            .format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.backingUp.zip", backupName);
                } else {
                    backupData = I18n
                            .format("net.daporkchop.pepsimod.wdl.gui.overwriteChanges.backingUp.folder", backupName);
                }
                ...
                WDLMessages.chatMessageTranslated(WDLMessageTypes.ERROR,
                        "net.daporkchop.pepsimod.wdl.messages.generalError.failedToSetUpEntityUI");
            } finally {
                backingUp = false;
