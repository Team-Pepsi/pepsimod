...
import net.daporkchop.pepsimod.wdl.api.IWDLModWithGui;
...
public class GuiWDLExtensions extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRenderer,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.extensions.title"), this.width / 2, 8,
                0xFFFFFF);
    ...
    private class ModList extends GuiListExtended {
        ...
        private class ModEntry extends GuiListEntry {
            ...
            public ModEntry(ModInfo<?> mod) {
                ...
                this.modDescription = I18n.format("net.daporkchop.pepsimod.wdl.gui.extensions.modVersion",
                        name, mod.version);
                ...
                if (mod.mod instanceof IWDLModWithGui) {
                    ...
                    if (buttonName == null || buttonName.isEmpty()) {
                        buttonName = I18n.format("net.daporkchop.pepsimod.wdl.gui.extensions.defaultSettingsButtonText");
                    }
                ...
                disableButton = new GuiButton(0, 0, 0, 80, 20,
                        I18n.format("net.daporkchop.pepsimod.wdl.gui.extensions."
            ...
            public boolean mousePressed(int slotIndex, int x, int y,
                ...
                if (disableButton.mousePressed(mc, x, y)) {
                    ...
                    disableButton.displayString = I18n.format("net.daporkchop.pepsimod.wdl.gui.extensions."
                            + (mod.isEnabled() ? "enabled" : "disabled"));
    ...
    private class ModDetailList extends TextList {
        ...
        public void drawScreen(int mouseX, int mouseY, float partialTicks) {
            ...
            drawCenteredString(fontRenderer,
                    I18n.format("net.daporkchop.pepsimod.wdl.gui.extensions.detailsCaption"),
