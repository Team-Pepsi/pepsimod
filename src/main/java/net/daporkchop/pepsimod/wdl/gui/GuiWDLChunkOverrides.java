...
import net.daporkchop.pepsimod.wdl.WDLPluginChannels.ChunkRange;
...
public class GuiWDLChunkOverrides extends GuiScreen {
    ...
    private static final ResourceLocation WIDGET_TEXTURES = new ResourceLocation(
            "net.daporkchop.pepsimod.wdl:textures/permission_widgets.png");
    /**
    ...
    public void initGui() {
        ...
        this.buttonList.add(new RequestModeButton(2, width / 2 - 105, 18, Mode.ERASING) {{
            enabled = false;
        }});
        this.buttonList.add(new RequestModeButton(3, width / 2 - 80, 18, Mode.MOVING) {{
            enabled = false;
        }});
