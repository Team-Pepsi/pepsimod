...
public class GuiWDLGenerator extends GuiScreen {
    ...
    @Override
    public void initGui() {
        this.seedText = I18n.format("net.daporkchop.pepsimod.wdl.gui.generator.seed");
        int seedWidth = fontRenderer.getStringWidth(seedText + " ");

        this.buttonList.clear();
        this.title = I18n.format("net.daporkchop.pepsimod.wdl.gui.generator.title",
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (Utils.isMouseOverTextBox(mouseX, mouseY, seedField)) {
            tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.generator.seed.description");
        } else if (generatorBtn.isMouseOver()) {
            tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.generator.generator.description");
        } else if (generateStructuresBtn.isMouseOver()) {
            tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.generator.generateStructures.description");
        }
    ...
    private void updateSettingsButtonVisibility() {
        if (WDL.worldProps.getProperty("MapGenerator", "").equals("flat")) {
            ...
            settingsPageBtn.displayString = I18n.format("net.daporkchop.pepsimod.wdl.gui.generator.flatSettings");
        } else if (WDL.worldProps.getProperty("MapGenerator", "").equals("custom")) {
            settingsPageBtn.visible = true;
            settingsPageBtn.displayString = I18n.format("net.daporkchop.pepsimod.wdl.gui.generator.customSettings");
        } else {
    ...
    private String getGeneratorText() {
        return I18n.format("net.daporkchop.pepsimod.wdl.gui.generator.generator." +
                WDL.worldProps.getProperty("MapGenerator"));
    }

    private String getGenerateStructuresText() {
        return I18n.format("net.daporkchop.pepsimod.wdl.gui.generator.generateStructures." +
