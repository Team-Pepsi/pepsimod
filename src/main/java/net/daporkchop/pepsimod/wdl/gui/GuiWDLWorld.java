...
public class GuiWDLWorld extends GuiScreen {
    ...
    public void initGui() {
        ...
        this.title = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.title",
        ...
        this.pickSpawnBtn = new GuiButton(5, this.width / 2, y, 100, 20,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.world.setSpawnToCurrentPosition"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (allowCheatsBtn.isMouseOver()) {
            tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.allowCheats.description");
        } else if (gamemodeBtn.isMouseOver()) {
            tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.gamemode.description");
        } else if (timeBtn.isMouseOver()) {
            tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.time.description");
        } else if (weatherBtn.isMouseOver()) {
            tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.weather.description");
        } else if (spawnBtn.isMouseOver()) {
            tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.spawn.description");
        } else if (pickSpawnBtn.isMouseOver()) {
            tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.setSpawnToCurrentPosition.description");
        }

        if (showSpawnFields) {
            if (Utils.isMouseOverTextBox(mouseX, mouseY, spawnX)) {
                tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.spawnPos.description", "X");
            } else if (Utils.isMouseOverTextBox(mouseX, mouseY, spawnY)) {
                tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.spawnPos.description", "Y");
            } else if (Utils.isMouseOverTextBox(mouseX, mouseY, spawnZ)) {
                tooltip = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.spawnPos.description", "Z");
            }
        }
    ...
    private String getAllowCheatsText() {
        return I18n.format("net.daporkchop.pepsimod.wdl.gui.world.allowCheats."
                + WDL.baseProps.getProperty("AllowCheats"));
    }

    private String getGamemodeText() {
        return I18n.format("net.daporkchop.pepsimod.wdl.gui.world.gamemode."
                + WDL.baseProps.getProperty("GameType"));
    }

    private String getTimeText() {
        String result = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.time."
                + WDL.baseProps.getProperty("Time"));

        if (result.startsWith("net.daporkchop.pepsimod.wdl.gui.world.time.")) {
            ...
            result = I18n.format("net.daporkchop.pepsimod.wdl.gui.world.time.custom",
                    WDL.baseProps.getProperty("Time"));
        }
    ...
    private String getWeatherText() {
        return I18n.format("net.daporkchop.pepsimod.wdl.gui.world.weather."
                + WDL.baseProps.getProperty("Weather"));
    }

    private String getSpawnText() {
        return I18n.format("net.daporkchop.pepsimod.wdl.gui.world.spawn."
