...
public class GuiWDLEntities extends GuiScreen {
    ...
    public void initGui() {
        ...
        presetsButton = new GuiButton(101, this.width / 2 + 5, 18, 150, 20,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.entities.rangePresets"));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRenderer,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.entities.title"), this.width / 2, 8,
                0xFFFFFF);
    ...
    private String getRangeModeText() {
        ...
        return I18n.format("net.daporkchop.pepsimod.wdl.gui.entities.trackDistanceMode." + mode);
    }
    ...
    private class GuiEntityList extends GuiListExtended {
...

        {
            ...
            try {
                ...
                WDLMessages.chatMessageTranslated(WDLMessageTypes.ERROR,
                        "net.daporkchop.pepsimod.wdl.messages.generalError.failedToSetUpEntityUI", e);
        ...
        private class CategoryEntry extends GuiListEntry {
            ...
            private String getButtonText() {
                if (groupEnabled) {
                    return I18n.format("net.daporkchop.pepsimod.wdl.gui.entities.group.enabled");
                } else {
                    return I18n.format("net.daporkchop.pepsimod.wdl.gui.entities.group.disabled");
                }
            }
        }
        ...
        private class EntityEntry extends GuiListEntry {
            ...
            public EntityEntry(CategoryEntry category, String entity) {
                ...
                this.rangeSlider = new GuiSlider(1, 0, 0, 150, 18,
                        "net.daporkchop.pepsimod.wdl.gui.entities.trackDistance", range, 256);
            ...
            private String getButtonText() {
                if (category.isGroupEnabled() && entityEnabled) {
                    return I18n.format("net.daporkchop.pepsimod.wdl.gui.entities.entity.included");
                } else {
                    return I18n.format("net.daporkchop.pepsimod.wdl.gui.entities.entity.ignored");
                }
            }
        }
    }
