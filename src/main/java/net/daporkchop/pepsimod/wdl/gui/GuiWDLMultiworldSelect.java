...
public class GuiWDLMultiworldSelect extends GuiTurningCameraBase {
    ...
    public void initGui() {
        ...
        this.acceptBtn = new GuiButton(-2, this.width / 2 + 5, this.height - 25,
                150, 20, I18n.format("net.daporkchop.pepsimod.wdl.gui.multiworldSelect.done"));
        ...
        this.newWorldButton = new GuiButton(-3, this.width / 2 - 155, 29, 150, 20,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.multiworldSelect.newName"));
    ...
    protected void actionPerformed(GuiButton button) {
        if (button.enabled) {
            if (button instanceof WorldGuiButton) {
                ...
                acceptBtn.enabled = selectedMultiWorld != null;
            } else if (button.id == -1) {
                callback.onCancel();
            } else if (button.id == -2) {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        this.drawCenteredString(this.fontRenderer,
                I18n.format("net.daporkchop.pepsimod.wdl.gui.multiworldSelect.subtitle"),
        ...
        if (this.searchField.getText().isEmpty() && !this.searchField.isFocused()) {
            drawString(fontRenderer,
                    I18n.format("net.daporkchop.pepsimod.wdl.gui.multiworldSelect.search"),
    ...
    public interface WorldSelectionCallback {
         ...
         *
         * @param selectedWorld The folder name for the given world.
         */
        void onWorldSelected(String selectedWorld);
    }
