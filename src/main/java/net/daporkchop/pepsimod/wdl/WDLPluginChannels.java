...
public class WDLPluginChannels {
    ...
    static void onWorldLoad() {
        ...
        WDLMessages.chatMessageTranslated(
                ...
                "net.daporkchop.pepsimod.wdl.messages.permissions.init");
        ...
        if ("WDL|CONTROL".equals(channel)) {
            ...
            switch (section) {
                case 0:
                    ...
                    WDLMessages.chatMessageTranslated(
                            WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                            "net.daporkchop.pepsimod.wdl.messages.permissions.packet0",
                ...
                case 1:
                    ...
                    WDLMessages.chatMessageTranslated(
                            WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                            "net.daporkchop.pepsimod.wdl.messages.permissions.packet1",
                ...
                case 2:
                    ...
                    WDLMessages.chatMessageTranslated(
                            WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                            "net.daporkchop.pepsimod.wdl.messages.permissions.packet2",
                            entityRanges.size());
                    break;
                case 3:
                    ...
                    WDLMessages.chatMessageTranslated(
                            WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                            "net.daporkchop.pepsimod.wdl.messages.permissions.packet3",
                ...
                case 4:
                    ...
                    WDLMessages.chatMessageTranslated(
                            WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                            "net.daporkchop.pepsimod.wdl.messages.permissions.packet4",
                ...
                case 5:
                    ...
                    if (replaceGroups) {
                        WDLMessages.chatMessageTranslated(
                                WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                                "net.daporkchop.pepsimod.wdl.messages.permissions.packet5.set",
                                numNewGroups, groupToEdit);
                    } else {
                        WDLMessages.chatMessageTranslated(
                                WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                                "net.daporkchop.pepsimod.wdl.messages.permissions.packet5.added",
                                numNewGroups, groupToEdit);
                    }
                    break;
                case 6:
                    ...
                    WDLMessages.chatMessageTranslated(
                            WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                            "net.daporkchop.pepsimod.wdl.messages.permissions.packet6",
                ...
                case 7:
                    ...
                    WDLMessages.chatMessageTranslated(
                            WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                            "net.daporkchop.pepsimod.wdl.messages.permissions.packet7",
                            numRangesRemoved, groupToSetTagFor, tag, numNewRanges);
                    break;
                default:
                    WDLMessages.chatMessageTranslated(
                            WDLMessageTypes.PLUGIN_CHANNEL_MESSAGE,
                            "net.daporkchop.pepsimod.wdl.messages.permissions.unknownPacket", section);
